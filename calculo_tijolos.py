...
def calcular():
    ...
    if ln1 == "" or ln2 == "" or tijolo == "":
        ...
        if tijolo == "6 furos":
            ...
            tela.ln_qt_tijolos.setText(f'{resultado1:,.2f}'.format(resultado1).replace(",", "X").replace(".", ",").replace("X", "."))

        elif tijolo == "8 furos":
            resultado2 = (largura * altura) / 0.0361
            tela.ln_qt_tijolos.setText(f'{resultado2:,.2f}'.format(resultado2).replace(",", "X").replace(".", ",").replace("X", "."))

        elif tijolo == "9 furos":
            resultado3 = (largura * altura) / 0.0551
            tela.ln_qt_tijolos.setText(f'{resultado3:,.2f}'.format(resultado3).replace(",", "X").replace(".", ",").replace("X", "."))
